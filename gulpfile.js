...
gulp.task('style:vendor', function(){
    return gulp
        .src([
            ...
            'src/stylus/vendor/lightgallery.min.css',
            'src/stylus/vendor/animate.css',
            'src/stylus/vendor/video-ratio.css',
            'src/stylus/vendor/animation-button.css',
...
// gulp.task('scripts:vendorMap', function(){
//     return gulp
//         .src([
//             'src/js/map/jquery.maphilight.min.js'
//         ])
...
gulp.task('video', function() {
    gulp.src(paths.src.contentVideo)
        .pipe(gulp.dest(paths.dist.contentVideo))
});
